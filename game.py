...
def mouseLeft(evt):
    for x in xrange(0,3):
        canvas.create_text(250+30*x,50,text = x,fill = "red",font = ("consolas",20),state="normal")
        #tk.uodate_idletasks()
        tk.update()
        time.sleep(1)
...
while 1:
    if ball.hit_bottom == False:
        ...
        canvas.create_text(250,50,text="game over",fill = "red",font=("consolas",30))
        tk.update()
        break
    tk.update_idletasks()
    tk.update()
